...
\begin{document}
	...
	I ekvation $ \ref{eq:Poissons ekvation} $ står $\bold w$ för hastigheten som hittills räknats ut i dem tidigare komponenterna av ekvationen, alltså inte den hastighet som är divergenslös i villkoret $ \ref{eq:villkor} $ 
