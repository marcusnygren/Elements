...
\end{lstlisting} 
	...
	\end{figure}
		...
		Resultatet ses i figur ~\ref{fig:resultat} och ~\ref{fig:resultat}. I ~\ref{fig:resultat} ses simuleringen 
		
		är en applikation där tre punktkällor är placerade jämte varandra, simulerade med olika desitet. Temperaturen ökar med tiden, vilket innebär att den punktkälla där röken har högst densitet stiger snabbast, se .
		
		 genererar rök jämte varandra, med olika densitet men samma temperatur. Efter en tid
