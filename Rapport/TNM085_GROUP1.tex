...
\begin{document}
	...
	\begin{center}
	----------- Här börjar implementationen // definiera variabler-----------
	\end{center}
	...
	Därefter appliceras divergensoperatorn på ekvation $ \ref{eq:vektor w} $ och och tillsammans med villkoret $ \ref{eq:villkor} $ blir resultatet, $ \ref{eq:Poisson ekvation} $, Poissons ekvation
