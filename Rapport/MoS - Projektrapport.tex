...
\begin{document}
	...
	\newpage
	\Section{Referenser}
		\emph{En lista på alla våra referenser i ordning där de används först i texten. Exempelvis: Papers på internet, böcker och andra externa informationskällor.}
